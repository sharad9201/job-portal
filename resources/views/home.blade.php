                ...
                <form action="search" method="get">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control pb-2 mt-5 rounded-pill " name="search_name"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center m-20">
                            <button type="button" class="btn btn-outline-secondary rounded-pill pb-2 mt-5"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-body mt-0_6">
                                    ...
                                    <p class="card-text mb-0_4">An adventure is an exciting experience that is typically
                                        bold, sometimes risky, undertaking. Adventures may be activities with some potential
                                        for physical dange, illo reiciendis corrupti, aliquid tempora blanditiis quia
    ...
    <div class="row two-column pt-5 pl-2 mt-5 ">
        ...
        <div class="colsm-12 col-md-6 mb-30">
            <div class="text-wrap p-45">
                ...
                <p class="my-15">Nepal is a country of contrasts. Spectacular natural riches combine with a vibrant culture
                    and sense of history. Home to ten of the world's 14 highest mountains, the country offers a magnificent
                    setting for hiking and mountaineering, as well as some of the world's best white water rafting.</p>
